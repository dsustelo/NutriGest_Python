...
#  Dec 26, 2023 08:39:57 PM GMT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1176x776+588+83
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    place $site_3_0.lab48 \
        -in $site_3_0 -x 0 -relx 0.065 -y 0 -rely 0.054 -width 0 \
        -relwidth 0.247 -height 0 -relheight 0.069 -anchor nw \
        -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra47 \
        -in $top -x 0 -relx 0.009 -y 0 -rely 0.026 -width 0 -relwidth 0.393 \
